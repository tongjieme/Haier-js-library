...
(function($) {
    ...
    var methods = {
        ...
        _onSubmitEvent: function(e){
            ...
            //edit by czf begin
            if(!options.asyncRequest){
                if(r && typeof options.disabledBtn != "undefined"){
                    //不是异步提交，且需要将按钮置为不可用时...
                    options.disabledBtn.each(function(){
                        this.disabled = true;
                    });
                    options.disabledBtn.addClass("btn-disabled");

                    setTimeout(function(){
                        options.disabledBtn.each(function(){
                            this.disabled = false;
                        });
                        options.disabledBtn.removeClass("btn-disabled");
                    }, 5000);
                }
                return r;
            }else{
                if(r){
                    ...
                    var ajaxConfig = {
                        ...
                        complete: function(){
                            ...
                            options.afterSubmit && options.afterSubmit();
                        }
                    };

                    if(typeof options.disabledBtn != "undefined"){
                        ajaxConfig.disabledBtn = options.disabledBtn;
                    }

                    HaierJS[form.attr("method")](ajaxConfig);
                }
            }
            //edit by czf end
        },
