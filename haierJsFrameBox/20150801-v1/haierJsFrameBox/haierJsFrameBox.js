...
(function ($, document, window) {
	...
	publicMethod.resize = function (options) {
		...
		if (open) {
			...
			publicMethod.position(typeof options.speed != "undefined" ? options.speed : (settings.get('transition') === "none" ? 0 : settings.get('speed')));
		}
	};
	...
	publicMethod.show = function () {
		launch(defaults.HaierObj);
	};
